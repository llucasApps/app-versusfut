      ...
      <main className="container mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="space-y-4">
          {filteredInvites.map((invite) => {
            ...
            return (
              <div key={invite.id} className="bg-gradient-to-br from-[#1A1A1A] to-[#0D0D0D] border border-[#FF5A00]/20 rounded-2xl p-5 sm:p-6 hover:border-[#FF5A00]/40 transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,90,0,0.15)]">
                {/* Header */}
                ...
                {invite.status === 'pending' && (
                  <div className="flex gap-3">
                    <button className="flex-1 bg-[#FF5A00] hover:bg-[#FF5A00]/90 text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2">
                ...
                {invite.status === 'accepted' && (
                  <div className="flex gap-3">
                    <button className="flex-1 bg-[#FF5A00]/10 text-[#FF5A00] font-medium py-3 px-4 rounded-xl flex items-center justify-center gap-2">
                      <CheckCircle className="w-5 h-5" />
                      Desafio Aceito
                    </button>
        ...
        {filteredInvites.length === 0 && (
          <div className="text-center py-20">
            ...
            <button className="inline-flex items-center gap-2 bg-[#FF5A00] hover:bg-[#FF5A00]/90 text-white font-bold py-3 px-8 rounded-xl transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,90,0,0.3)]">
